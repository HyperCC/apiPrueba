            ...
            <div style={style.paper}>
                ...
                <form style={style.form}>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} md={6}>
                            <TextField name="password" variant="outlined" fullWidth label="Ingrese su password " />
                        </Grid>
                        <Grid item xs={12} md={6}>
                            <TextField name="confirmacionPassword" variant="outlined" fullWidth label="Confirme su password " />
                        </Grid>
                    </Grid>
